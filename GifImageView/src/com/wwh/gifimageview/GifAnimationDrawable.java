...
public class GifAnimationDrawable extends AnimationDrawable {
	...
	public GifAnimationDrawable(File f) throws Exception {
		this(f, false);
	}

	public GifAnimationDrawable(InputStream is) throws Exception {
		this(is, false);
	}

	public GifAnimationDrawable(File f, boolean inline) throws Exception {
		this(new BufferedInputStream(new FileInputStream(f), 32768), inline);
	}

	public GifAnimationDrawable(InputStream is, boolean inline) throws Exception {
		super();
		InputStream bis = is;
